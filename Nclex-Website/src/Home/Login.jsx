      ...
      <div className='grid grid-cols-1 md:grid-cols-2 m-15 bg-gray-50 justify-center text-center rounded-2xl p-4 border h-auto w-auto max-w-6xl mx-auto shadow-xl'>
        <div className=' flex flex-col  m-1 justify-center align p-4 w-full bg-white shadow-2xl rounded-2xl text-black'>
          ...
          <form onSubmit={handleSubmit} className='max-w-xl ' action="">
            ...
            <button className='border bg-blue-700 text-black m-2 rounded-2xl p-2 hover:bg-white hover:text-black hover:shadow-xl hover:scale-105 transition-transform duration-300 ease-in-out' type='submit'>Submit</button>
            <h3 className='m-2'>Don't have an account <a className='text-blue-400' href="/register">Register</a> here!</h3>
          </form>
          {error && <p>{error}</p>}
        </div>
